...
public class ReserveSearchKey {

    // Avoid magic numbers.
    private static final int MAX_SIZE = 3;


    public ReserveSearchKey() {
        super();
    }


    public static void storeList(Context context, String pref_name, String key, List keyword) {
        ...
        Gson gson = new Gson();
        String jsonFavorites = gson.toJson(keyword);
    ...
    public static void addList(Context context, String pref_name, String key, String keyword) {
        ...
        if(favorites.contains(keyword)){

            favorites.remove(keyword);
