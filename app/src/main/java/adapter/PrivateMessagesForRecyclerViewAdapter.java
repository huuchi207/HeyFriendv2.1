...
public class PrivateMessagesForRecyclerViewAdapter extends FirebaseRecyclerAdapter<Message,MessageViewHolder> {
    ...
    public PrivateMessagesForRecyclerViewAdapter(Class<Message> modelClass, int modelLayout, Class<MessageViewHolder> viewHolderClass, DatabaseReference ref, Context context, String clientUid, String myUid, String clientPhotoURL) {
